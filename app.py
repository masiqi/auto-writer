...
max_message_termination = MaxMessageTermination(9)
...
gemini_client = OpenAIChatCompletionClient(
    ...
    base_url="https://gemini.96396.com/v1",
    model_capabilities = ModelCapabilities(
        vision=True,
        function_calling=True,
        json_output=True
...
single_agent_team = RoundRobinGroupChat([topic_analyst,central_idea_designer,user_proxy,title_designer,writer,preface_designer,judge], termination_condition=text_termination|max_message_termination)
...
task = '''优秀文化需要传承，它滋养着我们的精神；高超技艺需要传承，它凝聚着匠心情愫；良好家风需要传承，它是塑造品格的摇篮……传承是一种责任，也是一种使命。

请以“传承”为题写一篇文章。文体不限，诗歌除外。
要求：将作文题目写在答题卡上，作文内容积极向上，不少于600字，不要出现所在学校的校名或师生姓名。'''
task = '''题目：请以“我做对了这道选择题”为题，写一篇文章。不限文体（诗歌除外）。
要求：（1）请将作文题目抄写在答题卡上。
（2）作文内容积极向上。
（3）字数在600-800之间。
（4）不要出现所在学校的校名或师生姓名。'''
task = '''题目：请以“时光里的温情”为题目，写一篇作文。
要求：请将作文题目写在开头第一行上，作文内容积极向上，字数在600——800字之间，不出现学校的真实校名、师生姓名。'''
task = '''在生命的长河中，总有一些动听的声音萦绕着我们。山泉叮咚，是来自自然的悦耳之音；生命拔节，是来自成长的顽强之音；关爱叮咛，是来自师长的幸福之音；强国有我，是来自青年的奋进之音……

请以“最动听的声音”为题目，写一篇记叙文，可写实，可想象。文体不限，诗歌除外。
...
#（3）不要出现所在学校的校名或师生姓名。'''
task = '''荀子曾经说过：不登高山，不知天之高也；不临深渊，不知地之厚也。人世间的很多至理，往往是人在某次经历后猛然领悟到的，想你也有过这样的经历和感悟。
...
（3）字数在600-800之间。
（4）不要出现所在班级师生姓名。'''
task = ''' 图书馆是一座寂静而深邃的知识殿堂，无数的思想在这里诞生、碰撞；图书馆是一座连接过去、现在与未来的坚固桥梁，承载着人类文明的传承与发展……走进图书馆，会发生怎样的故事？

请以“走进图书馆，我……”为开头，自拟题目，写一篇文章，可写实，可想象，文体不限；诗歌除外。
要求：将作文题目写在答题纸上，作文内容积极向上，字数在600-800之间，不要出现所在学校的校名或师生姓名。'''
task = '''在网络时代，转发信息已成为我们生活的一部分。一个暖心的故事、一条震撼的视频、一句深刻的话语，都可能被我们转发。你曾转发过哪些信息？转发前后发生了哪些故事？对此你又有着怎样的思考或感悟呢？

请以“转发”为题，写一篇作文。文体不限，诗歌除外。
要求：将作文题目写在答题卡上，作文内容积极向上，字数在600-800之间，不出现学校的真实校名、师生姓名等。'''
task = '''许多城市都有能代表其文化特征并具有传承价值的事物，这些事物可以称作该城市的符号。故宫、四合院是北京的符号；天桥的杂耍、胡同小贩的吆喝是北京的符号；王府井商业街、中关村科技园是北京的符号……随着时代的发展，今后还会不断涌现出新的北京符号。保留以往的符号，创造新的符号，是北京人的心愿。

对此，请以“北京的符号”为题，写一篇文章，谈谈你的感受或看法。文体不限，诗歌除外。
要求：将作文题目写在答题卡上，作文内容积极向上，字数在600～800之间，不要出现所在学校的校名或师生姓名。'''
task = '''请以“谢谢你让我在良好的家风中成长”为题写一篇作文。根据自己的经历和感受，写一篇600—800字的记叙文，作文内容积极向上。'''
task = '''“忠厚传家远，诗书继世长”“积善之家必有余庆，积恶之家必有余殃”“淫慢则不能励精，险躁则不能治性”，这些话都是我国传统家风的写照。莫言说他的家风是“重视学习，与人为善”，傅雷教育孩子要“德艺俱备，人格卓越”……在一个人的成长过程中，家风起着重要的作用。家风是指一个家庭长期形成的道德准则、处事规范和行为方式，潜移默化于家庭日常生活之中。勤劳、诚实、孝悌、和睦、向善、进取等是中华民族家风的基本价值取向。你是否关注到了你家的家风？你是否感受到家风对你成长的影响？围绕你的学习或生活，一定发生过一些事，而这些事在一定程度上又体现着你家的家风。请以“谢谢你，让我在____的家风中成长”为题，写一篇作文。


要求：（1）结合自身经历，写出真情实感；（2）文中不得出现与自己相关的信息；（3）字数700字左右。
注意：请仔细分析导语及题目，什么才是值得我们传承的家风？不偷不抢、诚实守信等应该是一个人最基本的素质，但这些不是家风。
'''
task = '''每个人的生命中都会有那么一段特别的时光，或许是一些难忘的经历，或许是一段美好的回忆，又或许是遇见一些温暖的人……让我们用一颗感恩的心，去铭记那些心中有爱、有光、有梦想的日子，让那段时光成为我们心灵深处的力量和信仰，指引我们走向更加美好的未来！

请以“每一段时光都是良辰”为题目，写一篇文章。
要求：①自选角度，立意自定，文体自选（诗歌、戏剧除外）。②字迹工整，书写清楚，卷面整洁。③不少于600字。④不得套作、抄袭，不得透露个人信息。
'''
task = '''杨绛笔下善良的人力车夫老王，在逆境中充满勇气的盲聋女作家海伦·凯勒，为非洲农业作出突出贡献的水稻专家杨华德……每个人都有属于自己的独特光芒，我们也要看到自己的光芒。因为这光芒，我们便无惧征途的黑夜；因为这光芒，我们更热爱人间的烟火；因为这光芒，我们更坚定心中的远方……

上述内容引发了你怎样的联想和思考？请自拟题目，自选角度，写一篇文章。
要求：（1）紧扣主题，内容具体充实；（2）有真情实感；（3）文体不限（诗歌、戏剧除外）；（4）不少于600字；（5）文中请回避与你相关的人名、校名、地名。'''
task = '''面对挫折，范仲淹能“不以物喜，不以己悲”坦然面对，欧阳修仍能寄情山水，“与民同乐”。人生成长路上难免遇到坎坷，你又是如何面对的呢？

请你以“心宽，路自宽”为题，写一篇文章。
要求：①自定文意。②要有真情实感，不得抄袭和套作。③文中不要泄露个人信息。④书写认真工整，不少于600字，不限文体，诗歌除外。'''
task = '''走近北京，是亲近北京的景观建筑，是体验北京的习俗礼仪，是感受北京的人情风貌……走近北京，触发了你怎样的感悟，又带给你怎样的感召呢？
...
（3）字数在600-800之间。
（4）不要出现所在学校的校名或师生姓名。'''
task = '''餐桌上的一盘菜，看似平凡，却可能寄托着情感，彰显着文化，记录了时代变迁，传承着精神品质……
...
请以“传承”为题写一篇文章。文体不限，诗歌除外。
要求：将作文题目写在答题卡上，作文内容积极向上，不少于600字，不要出现所在学校的校名或师生姓名。'''
task = '''在历史的长河中，人类从未停止过跨越的脚步；跨越了高山大海、跨越了时空的界限、跨越了思想的束缚。每一次跨越，都是我们对未知的探索、对自我的挑战、对未来的憧憬。

请结合自己的生活经历，以“跨越”为题，写一篇作文。
要求：请将作文题目写在开头第一行上，作文内容积极向上，字数在600——800字之间，不出现学校的真实校名、师生姓名。'''
task = '''在你的心里，有没有那样一首歌？它大概是你反复吟唱的流行歌曲，也可能是经久流传的经典诗词，又或许是净化心灵的自然之音……我们把它分享到朋友圈，描绘生活的色彩；我们把它记录在口记里，见证情感的历程；我们把它当作朋友，获得安慰和支持……

请以“我心中的一首歌”为题，写一篇记叙文，讲述这首歌背后的故事，分享你的思考和感悟。可写实，可想象。
